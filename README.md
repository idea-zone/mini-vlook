###### ~DIV&搬运工：只是站在巨人的肩膀上~MINI-VLOOK: Vlook的简化版本^2022.05.20^`#对外公开|1.3.0#(green)`   **路人二***COPYRIGHT  © 2022 路人二. All Right Reserved*

<  `#作者|路人二#(theme1)` | `#对外公开|1.3.0#(green!)` | `#日期|2022-05-20#(blue)`  ]
...
* V1.0.0
  ...
  * 标签解析增强
    ...
    * 命令
      ...
      * `@@bqcolor` 和 `@@bqtab` 快速生成 `#彩虹引用#`和`#标签页引用（实验性功能）#`
    * 全局禁用/开启
